...
namespace LumiSoft.Net.IMAP.Client
{
	...
	public class IMAP_Client : IDisposable
	{
		...
		public void CreateFolder(string folderName)
		{
			...
			Core.SendLine(m_pSocket,"a1 CREATE \"" + EncodeUtf7(folderName) + "\"");
		...
		public void DeleteFolder(string folderName)
		{
			...
			Core.SendLine(m_pSocket,"a1 DELETE \"" + EncodeUtf7(folderName) + "\"");
		...
		public void RenameFolder(string sourceFolderName,string destinationFolderName)
		{
			...
			Core.SendLine(m_pSocket,"a1 RENAME \"" + EncodeUtf7(sourceFolderName) + "\" \"" + EncodeUtf7(destinationFolderName) + "\"");
		...
		public void SubscribeFolder(string folderName)
		{
			...
			Core.SendLine(m_pSocket,"a1 SUBSCRIBE \"" + EncodeUtf7(folderName) + "\"");
		...
		public void UnSubscribeFolder(string folderName)
		{
			...
			Core.SendLine(m_pSocket,"a1 UNSUBSCRIBE \"" + EncodeUtf7(folderName) + "\"");
		...
		public void SelectFolder(string folderName)
		{
			...
			Core.SendLine(m_pSocket,"a1 SELECT \"" + EncodeUtf7(folderName) + "\"");
		...
		public void CopyMessages(int startMsgNo,int endMsgNo,string destFolder,bool uidCopy)
		{
			...
			Core.SendLine(m_pSocket,"a1 " + uidC + "COPY " + startMsgNo + ":" + endMsg  + " \"" + EncodeUtf7(destFolder) + "\"");
		...
		public void StoreMessage(string folderName,byte[] data)
		{
			...
			Core.SendLine(m_pSocket,"a1 APPEND \"" + EncodeUtf7(folderName) + "\" (\\Seen) {" + data.Length + "}");
		...
		private bool IsStatusResponse(string line)
		{
			...
			if(line.ToLower().IndexOf("recent") > -1){
				return true;
			}
